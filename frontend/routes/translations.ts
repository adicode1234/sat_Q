...
export const UI_LABELS: Record<string, Record<AppLanguage, string>> = {
  ...
  visibleFeaturesTitle: { en: "Visible Features", hi: "दृश्यमान विशेषताएँ", bn: "दृश्यमान বৈশিষ্ট্যসমূহ" },
...
const PHRASE_DICTIONARY: Array<{ en: RegExp; hi: string; bn: string }> = [
  ...
  { en: /^Building & Settlements$/gi, hi: "इमारतें एवं बस्तियाँ", bn: "भवन ও জনবসতি" },
